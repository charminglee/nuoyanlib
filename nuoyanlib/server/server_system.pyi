...
_ALL_SERVER_ENGINE_EVENTS: List[str]
...
class NuoyanServerSystem(ServerSystem):
    ...
    def SetItemsToItemGrid(
        self: ...,
        player_id: str,
        cls_name: str,
        key: str,
        item_dict_list: List[Optional[dict]],
        sync: bool = True,
    ) -> None: ...
    def GetItemsFromItemGrid(self: ..., player_id: str, cls_name: str, key: str) -> List[Optional[dict]]: ...
    def SyncItemsToItemGrid(
        self: ...,
        player_id: str,
        namespace: str,
