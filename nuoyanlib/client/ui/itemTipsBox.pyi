...
class ItemTipsBox(ScreenNode):
    _itemTipsBoxNode: _ItemTipsBoxUI
    def __init__(self, namespace: str, name: str, param: dict) -> None: ...
    def __registerItemTipsBoxUI(self) -> None: ...
    def ShowItemHoverTipsBox(self, itemDict: dict) -> None: ...
...
class _ItemTipsBoxUI(ScreenNode):
    alphaTick: int
    tipsImg: ImageUIControl
    tipsPanel: BaseUIControl
    tipsLabel: LabelUIControl
    timer1: CallLater
    timer2: CallLater
    def __init__(self, namespace: str, name: str, param: dict) -> None: ...
