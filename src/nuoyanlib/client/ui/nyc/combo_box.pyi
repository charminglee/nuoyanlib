...
class NyComboBox(InteractableControl, NyControl):
    ...
    BindData = bind_data
    def set_callback(self, func: __ComboBoxCallbackType, cb_type: str = ComboBoxCallbackType.SELECT) -> bool: ...
    def remove_callback(self, func: __ComboBoxCallbackType, cb_type: str = ComboBoxCallbackType.SELECT) -> bool: ...
