...
class ScreenNodeExtension(ClientEventProxy):
    ...
    def _GridComponentSizeChangedClientEvent(self, args: ArgsDict) -> None: ...
    @staticmethod
    def button_callback(
        btn_path: str,
        *callback_types: str,
    ...
    def _create_binding_proxy(self, func: Callable) -> Callable: ...
    def _build_binding(self, func: Callable, flag: int, binding_name: str = "", collection_name: str = "") -> None: ...
    def _unbuild_binding(self, func: Callable) -> None: ...
    def _create_nyc(self, path_or_control: UiPathOrControl, typ: Type[_T], **kwargs: Any) -> _T: ...
    def _destroy_nyc(self, nyc: NyControl) -> bool: ...
