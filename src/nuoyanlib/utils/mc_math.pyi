...
def distance2nearest_entity(target: __Pos3OrEntityId) -> float: ...
def distance2nearest_player(target: __Pos3OrEntityId) -> float: ...
...
def to_aabb(pos1: FTuple3, pos2: FTuple3) -> Optional[Tuple[FTuple3, FTuple3]]: ...
