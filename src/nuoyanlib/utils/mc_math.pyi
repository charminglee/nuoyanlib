...
@overload
def distance_square(target1: FTuple2, target2: FTuple2) -> float: ...
@overload
def distance(target1: __Pos3OrEntityId, target2: __Pos3OrEntityId) -> float: ...
@overload
def distance(target1: FTuple2, target2: FTuple2) -> float: ...
def chunk_pos(pos: FTuple3) -> Optional[ITuple2]: ...
@overload
def polar_coord(coord: FTuple3, rad: bool = False, origin: FTuple3 = (0, 0, 0)) -> FTuple3: ...
@overload
def polar_coord(coord: FTuple2, rad: bool = False, origin: FTuple2 = (0, 0)) -> FTuple2: ...
@overload
def cartesian_coord(coord: FTuple3, rad: bool = False, origin: FTuple3 = (0, 0, 0)) -> FTuple3: ...
@overload
...
@overload
def box_vertices(pos1: FTuple3, pos2: FTuple3) -> List[FTuple3]: ...
@overload
def box_vertices(pos1: FTuple2, pos2: FTuple2) -> List[FTuple2]: ...
@overload
def box_min_max(pos1: FTuple3, pos2: FTuple3) -> List[FTuple3]: ...
@overload
def box_min_max(pos1: FTuple2, pos2: FTuple2) -> List[FTuple2]: ...
...
def rot_from_to(start: FTuple3, end: FTuple3) -> Optional[FTuple2]: ...
...
@overload
def median(arg1: Iterable[float], /) -> float: ...
@overload
def median(arg1: float, arg2: float, /, *args: float) -> float: ...
@overload
def var(arg1: Iterable[float], /) -> float: ...
@overload
def var(arg1: float, arg2: float, /, *args: float) -> float: ...
@overload
def std(arg1: Iterable[float], /) -> float: ...
@overload
def std(arg1: float, arg2: float, /, *args: float) -> float: ...
@overload
def mean(arg1: Iterable[float], /) -> float: ...
@overload
def mean(arg1: float, arg2: float, /, *args: float) -> float: ...
