...
__NumberT = TypeVar("__NumberT", bound=Union[float, int])
...
@overload
def mean(arg1: Iterable[__NumberT]) -> __NumberT: ...
@overload
def mean(arg1: __NumberT, arg2: __NumberT, /, *args: __NumberT) -> __NumberT: ...
