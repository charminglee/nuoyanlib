...
def hurt(
    ...
    :param str|None child_id: 伤害来源的子实体ID，默认为 None
    :param bool knocked: 是否造成击退；默认为 True
...
def hurt_mobs(
    ...
    :param float damage: 伤害
    :param str cause: 伤害来源， `ActorDamageCause <https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI/%E6%9E%9A%E4%B8%BE%E5%80%BC/ActorDamageCause.html?key=ActorDamageCause&docindex=1&type=0>`_ 枚举，支持自定义；默认为 ActorDamageCause.EntityAttack
    :param str|None attacker_id: 攻击者实体ID，默认为 None
    :param str|None child_id: 攻击者的子实体ID，默认为 None
    :param bool knocked: 是否产生击退；默认为 True
    :param bool force: 是否无视 `伤害免疫时间 <https://zh.minecraft.wiki/w/%E5%8F%97%E5%87%BB%E5%90%8E%E4%BC%A4%E5%AE%B3%E5%85%8D%E7%96%AB>`_ 强制造成伤害；默认为 False
...
def explode_damage(
    ...
    :param int dim: 爆炸维度
    :param bool fire: 是否造成火焰；默认为 False
    :param bool breaks: 是否破坏方块；默认为 True
    :param bool tile_drops: 破坏方块后是否生成掉落物；默认为 True
    :param bool mob_loot: 生物被炸死后是否生成掉落物；默认为 True
    :param bool hurt_source: 是否对爆炸伤害源实体造成伤害；默认为 False
...
def cylinder_damage(damage, r, pos1, pos2, dim, **kwargs):
    ...
    :param int dim: 维度
    :param str cause: [仅关键字参数] 伤害来源， `ActorDamageCause <https://mc.163.com/dev/mcmanual/mc-dev/mcdocs/1-ModAPI/%E6%9E%9A%E4%B8%BE%E5%80%BC/ActorDamageCause.html?key=ActorDamageCause&docindex=1&type=0>`_ 枚举，支持自定义；默认为 ActorDamageCause.EntityAttack
    :param str|None attacker_id: [仅关键字参数] 攻击者实体ID，默认为 None
    :param str|None child_id: [仅关键字参数] 攻击者的子实体ID，默认为 None
    :param bool knocked: [仅关键字参数] 是否产生击退；默认为 True
...
def percent_damage(
    ...
    :param str|None child_id: 伤害来源的子实体ID，默认为 None
    :param bool knocked: 是否造成击退；默认为 True
    :param bool force: 是否无视攻击冷却或生物的无敌状态强制设置伤害；默认为 False
