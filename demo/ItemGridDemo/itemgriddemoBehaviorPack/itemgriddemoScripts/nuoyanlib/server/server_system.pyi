...
from typing import List, Tuple, Callable, Union, Any, Dict, Optional
...
class NuoyanServerSystem(ServerSystem):
    ...
    def SetItemsToItemGrid(self: ..., player_id: str, key: str, item_dict_list: List[ItemDict]) -> List[bool]: ...
    def GetItemsFromItemGrid(self: ..., player_id: str, key: str) -> List[ItemDict]: ...
    def UpdateItemGrids(self: ..., player_id: str, keys: Union[str, Tuple[str, ...]]) -> bool: ...
    def SetQueryVar(self: ..., entity_id: str, name: str, value: float) -> bool: ...
